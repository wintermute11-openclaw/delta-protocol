...
- Das HUD zeigt Mission, Alarm, Waffe, Health und Game Over jetzt funktional, aber noch nicht als finale UI.
- Art-, Audio- und UI-Assets sind vorerst Platzhalter.
- Prüfen, ob die manuell gepflegte Input-Map, Autoload-Konfiguration, Missionsobjekte und die .tscn-Dateien in der verwendeten Godot-4.x-Version ohne Nacharbeit laden.
