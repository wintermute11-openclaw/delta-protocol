...
- Missionslogik, Serverziel, Optionalziel und Exfil fehlen absichtlich noch; das kommt erst ab Phase 6.
- Player-Tod ist weiterhin nur minimal umgesetzt; Game Over und sauberer Neustart kommen erst in Phase 7.
- Das HUD ist in Phase 5 bewusst klein und zeigt primär den Alarmstatus plus Debug-Infos für Waffe und Health.
- Art-, Audio- und UI-Assets sind vorerst Platzhalter.
- Prüfen, ob die manuell gepflegte Input-Map, Autoload-Konfiguration und die .tscn-Dateien in der verwendeten Godot-4.x-Version ohne Nacharbeit laden.
